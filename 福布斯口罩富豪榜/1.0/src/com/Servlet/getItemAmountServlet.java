...
public class getItemAmountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        userInfo ui = (userInfo) req.getSession().getAttribute("alreadyDeployUserInfo");
        String city=null;
        if (ui!=null){
            city =ui.getResentRegion();
        }

        if (city==null||city.equals("")||city.equals(" ")){
            userInfo ui2 = (userInfo) req.getSession().getAttribute("ui");
            city =ui2.getResentRegion();
        }
