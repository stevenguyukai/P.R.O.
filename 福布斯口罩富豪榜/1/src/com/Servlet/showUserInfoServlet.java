...
public class showUserInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String location = req.getParameter("locationNeed");
        String  city = req.getParameter("cityNeed");
        ...
        if (location == null  || location == "false"){
            ...
            req.getSession().setAttribute("ResentLatitude",ResentLatitude);
            req.getSession().setAttribute("ResentLongitude",ResentLongitude);
            req.getSession().setAttribute("ResentRegion",ResentRegion);
