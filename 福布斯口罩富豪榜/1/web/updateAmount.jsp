...
<div class="big">
    ...
    <%
        ...
        String OPENID = ui.getOPENID();
        if (OPENID==null||OPENID.equals("")||OPENID.equals(" ")){
            userInfo ui2= (userInfo)request.getSession().getAttribute("ui");
            OPENID = ui2.getOPENID();
        }
    ...
    <div class="myForm">
        <form id="myForm" method="post" action="user/getItemAmount">
            <div class="number">
                ...
                <input type="hidden" name="userID" value="<%=OPENID%>" readonly="readonly" />
            </div>
            <span id="alert"></span>
        </form>
