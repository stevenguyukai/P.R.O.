...
//        String wxName = req.getParameter("wxName");
//        String wxSex = req.getParameter("wxSex");
//        String wxProvince = req.getParameter("wxProvince");
//        String wxCity = req.getParameter("wxCity");
//        String wxAvatar = req.getParameter("wxAvatar");
//
//        req.setAttribute("wxOpenID",wxOpenID);
//        req.setAttribute("wxName",wxName);
//        req.setAttribute("wxSex",wxSex);
//        req.setAttribute("wxProvince",wxProvince);
//        req.setAttribute("wxCity",wxCity);
//        req.setAttribute("wxAvatar",wxAvatar);
