...
<div :style="getLoca" class="getLocation">
    ...
    <div class="getLocationDiv">
        <div class="getLocationTextDiv" style="width: 90%; height: 90%; margin-left: 5%; margin-top: 5%;">
            ...
            <form action="user/get" method="get" id="postLocationForm">
...
//            String wxName= (String)  request.getAttribute("wxName");
//            String wxSex= (String)  request.getAttribute("wxSex");
//            String wxProvince= (String)  request.getAttribute("wxProvince");
//            String wxCity= (String)  request.getAttribute("wxCity");
//            String wxAvatar= (String)  request.getAttribute("wxAvatar");
    ...
    <div class="disableForm">
        <form id="disableForm" class="userInfoForm" method="post" action="user/postInfo" style="display: block">
            <input type="hidden" readonly="true" style="border: white" name="Name" :value="userName" />
            ...
            <input type="hidden" readonly="true" style="border: white" name="ResentLatitude"
                   :value="userResentLatitude"/>
            <input type="hidden" readonly="true" style="border: white" name="ResentLongitude"
                   :value="userResentLongitude"/>
