...
Page({
  ...
  data: {
    ...
    settingDarkLightModeText: "自动模式",
    settingDarkLightModeTextColor: "#53aadd",
    sliderValue: 50,
  ...
  //永亮/永暗/自动 模式切换
  everDarkLightBtnChange(e) {
    if (e.detail.value < 33) {
      // 黑暗模式
      app.globalData.everDarkMode = true
      app.globalData.everLightMode = false
      app.globalData.darkLightAuto = false
      app.globalData.darkMode = true

      var oftenPlayGameBackup = this.data.oftenPlayGames
      ...
      this.setData({
        ...
        settingDarkLightModeText: "永暗模式",
        settingDarkLightModeTextColor: "#8369f6",
      })
    ...
    } else if (e.detail.value >= 33 && e.detail.value <= 66) {
      // 自动模式
      app.globalData.everDarkMode = false
      app.globalData.everLightMode = false
      app.globalData.darkLightAuto = true
      ...
      // 明亮模式
      app.globalData.everDarkMode = false
      app.globalData.everLightMode = true
      app.globalData.darkLightAuto = false
      app.globalData.darkMode = false
      ...
      this.setData({
        ...
        settingView: "settingView",
        settingScroll: "settingScroll",
        settingDarkLightModeText: "永亮模式",
        settingDarkLightModeTextColor: "#f19336",
      })
      wx.setBackgroundColor({
        backgroundColor: '#ecf0f3',
      })
  ...
  onShow: function () {
    ...
    // 如果用户没有上传名字或者头像，则上传
    if (!app.globalData.isUploadUserInfo) {
      app.uploadUserInfo();
    }
    ...
    if (app.globalData.darkMode) {
      ...
      }else if(app.globalData.everLightMode){
        this.setData({
          sliderValue: 100,
          settingDarkLightModeText: "永亮模式",
          settingDarkLightModeTextColor: "#f19336",
        })
      }else if(app.globalData.everDarkMode){
        this.setData({
          sliderValue: 1,
          settingDarkLightModeText: "永暗模式",
          settingDarkLightModeTextColor: "#8369f6",
