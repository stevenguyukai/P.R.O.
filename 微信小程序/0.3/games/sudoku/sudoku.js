...
Page({
    ...
    if (this.data.hintRemain > 0) {
      ...
      if (answerSheetWithEmpytGrid.length == 0) {
        ...
        if (hintValue == isSelect) {
          if (hintx < 3) {
            if (hinty < 3) {
              addUpRemainNum(this.data.sudokuGrid1[(((hintx * 3) + (hinty + 1)) - 1)].value, this);
              this.setData({
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
            ...
            } else if (hinty >= 3 && hinty < 6) {
              addUpRemainNum(this.data.sudokuGrid2[(((hintx * 3) + (hinty - 2)) - 1)].value, this);
              this.setData({
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
              ...
              addUpRemainNum(this.data.sudokuGrid3[(((hintx * 3) + (hinty - 5)) - 1)].value, this);
              this.setData({
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
          ...
          } else if (hintx >= 3 && hintx < 6) {
            if (hinty < 3) {
              addUpRemainNum(this.data.sudokuGrid4[((((hintx - 3) * 3) + (hinty + 1)) - 1)].value, this);
              this.setData({
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
              ...
              addUpRemainNum(this.data.sudokuGrid5[((((hintx - 3) * 3) + (hinty - 2)) - 1)].value, this);
              this.setData({
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
              ...
              addUpRemainNum(this.data.sudokuGrid6[((((hintx - 3) * 3) + (hinty - 5)) - 1)].value, this);
              this.setData({
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
            ...
            if (hinty < 3) {
              addUpRemainNum(this.data.sudokuGrid7[((((hintx - 6) * 3) + (hinty + 1)) - 1)].value, this);
              this.setData({
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
              ...
              addUpRemainNum(this.data.sudokuGrid8[((((hintx - 6) * 3) + (hinty - 2)) - 1)].value, this);
              this.setData({
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
              ...
              addUpRemainNum(this.data.sudokuGrid9[((((hintx - 6) * 3) + (hinty - 5)) - 1)].value, this);
              this.setData({
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "#aaa",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
                })
                setTimeout(() => {
                  this.setData({
                    ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
          ...
          if (hintx < 3) {
            if (hinty < 3) {
              ...
              this.setData({
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid1[" + (((hintx * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid2[" + (((hintx * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid3[" + (((hintx * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
            ...
            if (hinty < 3) {
              ...
              this.setData({
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid4[" + ((((hintx - 3) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid5[" + ((((hintx - 3) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid6[" + ((((hintx - 3) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
            ...
            if (hinty < 3) {
              ...
              this.setData({
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].value"]: hintValue,
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid7[" + ((((hintx - 6) * 3) + (hinty + 1)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].value"]: hintValue,
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid8[" + ((((hintx - 6) * 3) + (hinty - 2)) - 1) + "].fontColor"]: "#5e6473",
              ...
              this.setData({
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].value"]: hintValue,
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "red",
                ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].backgroundColor"]: "none",
              })
              setTimeout(() => {
                this.setData({
                  ["sudokuGrid9[" + ((((hintx - 6) * 3) + (hinty - 5)) - 1) + "].fontColor"]: "#5e6473",
  ...
  easy() {
    wx.vibrateShort();
    this.setData({
      modePic: "https://assets-ouch.icons8.com/thumb/866/7387d6d9-81eb-405c-854f-d73b00b8e789.png",
      mode: "进入简单模式",
  ...
  middle() {
    ...
    this.setData({
      mode: "进入普通模式",
      modePic: "https://assets-ouch.icons8.com/thumb/260/d6b985f4-a663-4d44-a4c9-655e04bb8e1b.png",
      selectButton1: "selectButton1",
  ...
  hard() {
    ...
    this.setData({
      mode: "进入困难模式",
      modePic: "https://assets-ouch.icons8.com/thumb/883/692df9a7-d400-49c9-a00d-de972eae7197.png",
      selectButton1: "selectButton1",
      selectButton2: "selectButton2",
  ...
  epic() {
    ...
    this.setData({
      mode: "进入噩梦模式",
      modePic: "https://assets-ouch.icons8.com/thumb/58/3ee5a5ab-9990-4b50-a3b0-ff71ee4df456.png",
      selectButton1: "selectButton1",
      selectButton2: "selectButton2",
      selectButton3: "selectButton3",
  ...
  sudokuTap(e) {
    ...
    //减去不应该在提示数组中的元素（执行逻辑）
    for (var i = 0; i < answerSheetWithEmpytGrid.length - 1; i++) {
      for (var j = 0; j < deleteCorrectElement.length - 1; j++) {
        if (answerSheetWithEmpytGrid[0][0] != "" && answerSheetWithEmpytGrid[0][0] != undefined) {
